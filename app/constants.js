...
const experiences = [
  {
    ...
    points: [
      "Wrote and maintained essential display drivers",
    ...
    detailed_points: [
      ...
      "Wrote and owned several of the shipped display drivers (Cirrus Logic, Matrox, Weitek, and Tseng Labs).",
  ...
  },
  {
    ...
    points: [
      "Led team that wrote and maintained drivers for broadcast TV capture cards",
  ...
  },
  {
    ...
    points: [
      "Technical lead for Display, Graphics and Image Decoder teams on BREW.",
